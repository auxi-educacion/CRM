    ...
    <div  className="md:flex md:min-h-screen">
      <aside className="md:w-1/4 bg-blue-900 px-5 py-10">
        ...
        <nav className="mt-10">
          ...
          <Link className={`${ location.pathname === '/cliente/nuevo'? 'text-blue-300' : 'text-white'} text-2xl block mt-2 hover:text-blue-300 text-white` } to="/cliente/nuevo">Nuevos Clientes</Link>
        </nav>
      </aside>
